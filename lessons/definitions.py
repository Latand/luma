...
LESSONS: tuple[Lesson, ...] = (
    Lesson(
        ...
        summary='Влучити в ноту, утримати її рівно — і проспівати перші п’ять щаблів гами вгору і назад униз.',
        description='Спочатку чотири витримані ноти на «ма»: вдихни носом і тримай звук рівно, без коливань. '
                    'Далі гама 1-2-3-4-5-4-3-2-1 на той самий склад: п’ять тональностей по півтону вгору і назад униз, у паузі — спокійний вдих. '
    ...
    Lesson(
        ...
        description='Арпеджіо 1-3-5-8-5-3-1 на «но», терції 1-3-2-4-3-5-4-2-1 на «лі» суцільною лінією без поштовхів, '
                    ...
                    'У кожній вправі шість тональностей по півтону вгору і назад униз, вдих лише в паузі. Рівень «Звично», коридор ±50 ¢. '
    ...
    Lesson(
        ...
        description='Гама 1-2-3-4-5-6-7-8-9 і назад шістнадцятими на «а» — рівно, без прискорення в кінці. '
                    ...
                    'Темп 110, кожну вправу ведемо по півтону вгору і назад униз; вдих у паузі, плечі опущені. Рівень «Точно», коридор ±35 ¢. '
